...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AllergenController' => 'getAllergenControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FpGkjTpeYU', 0, (\dirname(__DIR__, 3).'/share/dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('qU87ZUwIig', 0, (\dirname(__DIR__, 3).'/share/dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AllergenController', 'App\\Controller\\CategoryController', 'App\\Controller\\ContactController', 'App\\Controller\\DishController', 'App\\Controller\\HomeController', 'App\\Controller\\MenuController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ReservationController', 'App\\Controller\\SecurityController', 'App\\Controller\\SubCategoryController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9v8V4ScgOX', 0, (\dirname(__DIR__, 3).'/share/dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AllergenRepository' => ['privates', 'App\\Repository\\AllergenRepository', 'getAllergenRepositoryService', true],
            ...
            'App\\Repository\\AllergenRepository' => '?',
